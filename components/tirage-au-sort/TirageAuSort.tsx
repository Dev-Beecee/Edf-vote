...
export function TirageAuSort({ boutiques, participations }: TirageAuSortProps) {
    ...
    return (
        <div className="grid gap-6 mt-8 p-6 bg-white rounded-lg shadow">
            <h2 className="text-xl font-bold">Tirage au sort</h2>

            {/* Sélection des boutiques */}
            <div>
                <Label htmlFor="boutiques">Boutiques participantes</Label>
                <MultiSelect
            ...
            {/* Nombre de gagnants */}
            <div>
                <Label htmlFor="winners">Nombre de gagnants</Label>
                <Input
                    id="winners"
                    type="number"
                    min="1"
            ...
            {winners.length > 0 && (
                <div className="mt-6">
                    <div className="flex justify-between items-center mb-3">
                        <h3 className="text-lg font-semibold">Résultats du tirage</h3>
                        <Button
