...
export const HeroSection = () => {
  return (
    <>
      <section className="flex flex-col items-center justify-center min-h-screen py-12 px-4 relative hero-bg-responsive" style={{
        ...
        <div className="relative mx-auto px-8 py-4 transform -rotate-1" style={{ backgroundColor: '#0e89ff', borderRadius: '16px', marginTop: '55px' }}>
         ...
         <div className="text-center text-4xl md:text-5xl lg:text-6xl font-bold font-hore" style={{ color: '#001A70' }}>
        ...
        <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Link href="/participation">
            <button 
              className="px-6 py-3 text-white font-semibold font-edf2020 uppercase"
              style={{ 
        ...
        {/* Section des prix */}
        <div className="mt-8 mb-8 md:mb-0 max-w-4xl mx-auto px-4">
          <p className="text-right font-work-sans italic" style={{ color: '#001A70' }}>
            À LA CLÉ ?
          </p>
